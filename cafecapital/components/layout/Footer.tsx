...
const contactInfo = [
  { icon: Phone, label: "Hotline", value: "0988 000 000" },
  { icon: Mail, label: "Email", value: "contact@cafecapital.vn" },
  { icon: MapPin, label: "Địa chỉ", value: "Quận 1, TP. Hồ Chí Minh" },
  { icon: MessageCircle, label: "Zalo OA", value: "Cafe Capital Official" },
];
